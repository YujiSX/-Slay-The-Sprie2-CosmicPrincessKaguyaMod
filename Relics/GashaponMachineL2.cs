...
namespace Kaguya.Relics
{
    ...
    public sealed class GashaponMachineL2 : CustomRelicModel
    {
        ...
        public override string PackedIconPath => "res://images/relics/gashapon_machine_l2.png";
        protected override string PackedIconOutlinePath => "res://images/relics/gashapon_machine_l2_outline.png";
        protected override string BigIconPath => "res://images/relics/gashapon_machine_l2_big.png";
        ...
        private static IEnumerable<RelicModel> GetValidRelics(IRunState state)
        {
            var orobasOptions = ModelDb.Event<Orobas>().AllPossibleOptions
                .Where(o => o.Relic != null && o.Relic.IsAllowed(state) && !(o.Relic is GashaponMachineL2));
