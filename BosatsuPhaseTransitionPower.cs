...
{
    public sealed class BosatsuPhaseTransitionPower : CustomPowerModel
    {
        ...
        {
            if (!wasRemovalPrevented && creature == Owner && Owner.Monster is TsukitoBosatsu bosatsu)
            {
                _isReviving = true;
                await bosatsu.TriggerRevive();
            }
        }
